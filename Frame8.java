...
public class Frame8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter the copies");
        ...
        jLabel1.setText("ADD EXTRA COPIES");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(eid, javax.swing.GroupLayout.DEFAULT_SIZE, 92, Short.MAX_VALUE)
                    .addComponent(ec))
                .addGap(304, 304, 304))
            .addGroup(layout.createSequentialGroup()
                .addGap(346, 346, 346)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            int bal=0;
            String id = null,name1 = null,name2 = null;
            Scanner input= new Scanner(System.in);
             int eid1=Integer.parseInt(eid.getText());
             int ec1=Integer.parseInt(ec.getText());
            ...
            String s1="select * from books where bookid="+eid1;
            Statement stmt= con.createStatement();
            ResultSet rs= stmt.executeQuery(s1);
            while(rs.next()){
                bal=rs.getInt(4);
                id=String.valueOf(rs.getInt("bookid"));
                name1=rs.getString("bookname");
                name2=rs.getString("bookauthor");
                
                
               
                }
            bal=bal+ec1;
            String c=Integer.toString(bal);
            String tb[]={id,name1,name2,c};
               DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
               model.addRow(tb);
             Statement stmt31  = con.createStatement();
	    stmt31.executeUpdate("UPDATE books set copies = "+bal+" where bookid = "+eid1);
            eid.setText("");
            ec.setText("");
