...
public class Frame3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Bookid");
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Bookname");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Authorname");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Copies");
        }
